  ...
  return (
    <div className="w-3/4 mx-auto grid grid-cols-4 gap-16 mt-16">
      <div className="text-center">
        <img
          className="border-black border-2 rounded-full aspect-w-1 aspect-h-1 transform hover:scale-110 transition-transform"
          src={Anirud}
        ...
        <div className="w-1/3 mx-auto grid grid-cols-2 ">
          <a
      ...
      <div className="text-center">
        ...
        <div className="w-1/3 mx-auto grid grid-cols-2 ">
          ...
          <a
            href="https://github.com/nganguly0594"
            target="_blank"
            className="flex justify-between"
            rel="noreferrer"
          >
      ...
      <div className="text-center">
        ...
        <div className="w-1/3 mx-auto grid grid-cols-2 ">
          ...
          <a
            href="https://github.com/adeshkumar1"
            target="_blank"
            className="flex justify-between"
            rel="noreferrer"
          >
      ...
      <div className="text-center">
        ...
        <div className="w-1/3 mx-auto grid grid-cols-2 ">
          ...
          <a
            href="https://github.com/theodoreng15"
            target="_blank"
            className="flex justify-between"
            rel="noreferrer"
          >
