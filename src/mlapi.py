...
def getEmbedQuery(level, skin):
    ...
    complete = client.chat.completions.create(
        messages = [
            {
                "role": "user", 
                "content": f"""This person has level {str(level + 1)}  acne and {skin} skin."""
        ...
        messages = [
            {
                ...
                1. DO NOT TYPE ANYTHING THAT IS NOT DOCTOR LIKE.
                2. Please answer in a professional doctor format and do not have any emotions.
